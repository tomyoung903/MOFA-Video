...
def sample_inputs(unimatch, pixel_values):
    ...
    flows = get_optical_flows_1t(unimatch, pixel_values)  # [b, T-1, 2, h, w]
    ...
    '''
        sparse_optical_flow: [1, 13, 2, 256, 256] (-256, 256) tensor
        mask: [1, 13, 2, 256, 256] {0, 1} tensor
        # viz_poses: [1, 14, 256, 256, 3] (0, 255) numpy
    '''
...
def main():
    ...
    if args.controlnet_model_name_or_path:
        ...
        controlnet = FlowControlNet.from_pretrained(
                    ...
                    if (
                        ...
                        with torch.autocast(
                            ...
                            for val_img_idx in range(args.num_validation_images):
                                ...
                                total_nps = np.concatenate([ctrl_nps, unimatch_flow_nps, sparse_flow_nps, esti_flow_nps, out_nps, gt_nps], axis=2)
